...
# # can write
# url1 <- "https://docs.google.com/spreadsheets/d/1SDA_Gu7vCHr1hBXtgD7xB77SHd4YKy4zLZDrwnao0pM/pubhtml"
# # view only
# url2 <- "https://docs.google.com/spreadsheets/d/1hxMnaI-GQ7sfDt3fN93Q8Pv67u23tbegN5NHFxNHL2M/pubhtml"
# 
# sheet1 <- open_by_url(url1, visibility = "public")
# sheet2 <- open_by_url(url2, visibility = "public")
# 
# test_that("Open a public spreadsheet", {
#   
#   expect_that(sheet1, is_a("spreadsheet"))
#   expect_that(sheet2, is_a("spreadsheet"))
# })
# 
# # # Requires LOGIN since setting visibility is private
# # test_that("Open spreadsheet from sharing link", {
# #   # Private Spreadsheets
# #   ## read only
# #   url1 <- "https://docs.google.com/spreadsheets/d/1hxMnaI-GQ7sfDt3fN93Q8Pv67u23tbegN5NHFxNHL2M/edit?usp=sharing"
# #   ## can write
# #   url2 <- "https://docs.google.com/spreadsheets/d/1SDA_Gu7vCHr1hBXtgD7xB77SHd4YKy4zLZDrwnao0pM/edit?usp=sharing"
# #          
# #   sheet1 <- open_by_url(url1)
# #   sheet2 <- open_by_url(url1)
# #   
# #   expect_that(sheet1, is_a("spreadsheet"))
# #   expect_that(sheet2, is_a("spreadsheet"))
# #   
# #   expect_error(open_by_url(url1, visibility = "public"), "Please check visibility settings.")
# # })