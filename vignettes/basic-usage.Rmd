...
## Get a worksheet report

To get a more detailed report of your worksheet, use `report()`. This function summarizes your worksheet by letting you know the number of rows and columns, empty cells, and the cell pattern per column (a string of ##V for values and ##NA for empty cells).
```{r generate report}
